...
public class MainActivity extends AppCompatActivity {
    ...
    private ForecastAdapater mForecastAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Sacado de la solucion: The reverseLayout parameter is useful mostly for HORIZONTAL layouts
        // that should reverse for right to left languages
        ...
        //Sacado de la solucion: Use this setting to improve performance if you know that changes in content do not
        // change the child layout size in the RecyclerView
        mRecyclerView.setHasFixedSize(true);

        // TODO (41) set mForecastAdapter equal to a new ForecastAdapter
        mForecastAdapter = new ForecastAdapater();
